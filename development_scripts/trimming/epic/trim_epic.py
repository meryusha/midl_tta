...
def trimm_epic_kitchens_video(input_path, ann_dict, clip_name, outpath):
    ...
    input_video = f"{input_path}/{folder_id}/{video_id}.MP4"
    out_path_clip = f'{outpath}/{clip_name}.mp4'
    print(f'Trimming video: {clip_name}')
    try:
...
def group_annotations_per_narration(annotations):
    ...
    grouped = annotations_df.groupby('narration_id')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', type=str, default='/home/username/epic-kitchens/videos')
    parser.add_argument('--annotations', type=str, default='/home/username/epic-kitchens/annotations/EPIC_100_train.csv')
    parser.add_argument('--outpath', type=str, default='/home/username/epic-kitchens/clips')
    ...
    trimm_epic_kitchens_video(args.input_path, json_annotations[clip_name], clip_name, args.outpath)